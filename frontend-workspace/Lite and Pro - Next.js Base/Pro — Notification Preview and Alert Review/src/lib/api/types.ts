...
// POST /notifications/simulate exists in the contract but is deliberately
// unused in both Lite and Pro: Confirm & Send is simulated locally, so the
// client makes no writes. Its request type is omitted rather than left as an
