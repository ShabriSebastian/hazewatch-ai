...
export default function AlertHistoryPlaceholder() {
  return (
    <AppShell activePage="alert-history">
      <main className="p-8">
        <div className="mx-auto max-w-2xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-3 text-slate-600">Placeholder route only. The final screen will be added from the next supplied visual.</p>
